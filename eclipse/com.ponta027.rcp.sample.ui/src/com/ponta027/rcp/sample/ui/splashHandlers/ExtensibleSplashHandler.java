package com.ponta027.rcp.sample.ui.splashHandlers;
...
import com.ponta027.rcp.sample.ui.Activator;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
	...
	private final ArrayList fImageList;

	private final ArrayList fTooltipList;

	private final static String F_SPLASH_EXTENSION_ID = "com.ponta027.rcp.sample.ui.splashExtension"; // NON-NLS-1
	...
	private void createUI() {
		...
		fIconPanel = new Composite(splash, SWT.BORDER);
		...
		Label label = new Label(fIconPanel, SWT.BORDER);

		label.setText("テストバージョン"
