...
public class FtaFactoryImpl extends EFactoryImpl implements FtaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FtaPackage.HAZARD: return createHazard();
			case FtaPackage.EVENT: return createEvent();
			case FtaPackage.CONDITION: return createCondition();
			default:
