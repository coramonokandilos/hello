 ...
 * <ul>
 *   <li>{@link com.ponta027.fta.model.fta.impl.HazardImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HazardImpl extends DiagramImpl implements Hazard {
	/**
	...
	protected EClass eStaticClass() {
		return FtaPackage.Literals.HAZARD;
	}
	...
	public EList<Condition> getConditions() {
		if (conditions == null) {
			conditions = new EObjectResolvingEList<Condition>(Condition.class, this, FtaPackage.HAZARD__CONDITIONS);
		}
		return conditions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FtaPackage.HAZARD__CONDITIONS:
