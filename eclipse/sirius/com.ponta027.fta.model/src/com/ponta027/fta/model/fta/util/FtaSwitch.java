...
public class FtaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FtaPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FtaPackage.HAZARD: {
				Hazard hazard = (Hazard)theEObject;
				T result = caseHazard(hazard);
				if (result == null) result = caseDiagram(hazard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FtaPackage.EVENT: {
				...
				if (result == null) result = caseDiagram(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FtaPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = caseDiagram(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
