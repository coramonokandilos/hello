...
/**
 * This is the item provider adapter for a {@link com.ponta027.fta.model.fta.Hazard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HazardItemProvider extends DiagramItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hazard_conditions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hazard_conditions_feature", "_UI_Hazard_type"),
				 FtaPackage.Literals.HAZARD__CONDITIONS,
				 true,
				 false,
				 true,
				 null,
