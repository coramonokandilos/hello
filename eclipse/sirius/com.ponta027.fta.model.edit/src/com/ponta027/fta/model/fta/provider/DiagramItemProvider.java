...
/**
 * This is the item provider adapter for a {@link com.ponta027.fta.model.fta.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FtaPackage.Literals.DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDetailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_detail_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_detail_feature", "_UI_Diagram_type"),
				 FtaPackage.Literals.DIAGRAM__DETAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FtaPackage.Literals.DIAGRAM__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Diagram.class)) {
			case FtaPackage.DIAGRAM__NAME:
			case FtaPackage.DIAGRAM__DETAIL:
			case FtaPackage.DIAGRAM__ID:
